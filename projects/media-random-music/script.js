...
i++;
total = i;
comMessagePrint = `<h3 class="tCenter"><span class="op">Random Music</span><br><br>${q2} ${i}</h3>`;
document.getElementsByTagName('title')[0].innerHTML = `Random Music ${q2}`;
}
