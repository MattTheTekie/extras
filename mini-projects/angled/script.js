...
while (n < max) {
let randTop = randomIntFromInterval(-10, 100);
let randTop2 = randomIntFromInterval(-10, 100);

let randLeft = randomIntFromInterval(-10, 100);
let randLeft2 = randomIntFromInterval(-10, 100);
